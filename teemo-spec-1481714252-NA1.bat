...
if exist "League of Legends.exe" (  
	@start "" "League of Legends.exe" "8394" "LoLLauncher.exe" "" "spectator 54.94.140.168:80 1b1D6WsRNbkyj5OqEqDt8MVxU2nNKlQn 1481714252 NA1"
	goto exit
)
:cannotFind
echo ===================
echo KR: LOL 경로를 자동으로 찾을 수 없습니다. 도움말에서 관전하기 문제 해결을 보시면 100% 해결 될 수 있습니다. 100% 해결 될 수 있으니, 채팅방에서 괜히 사서 고생해서 물어보지마세요!!!!!!!
echo EN: Cannot found LOL directory path for automatic. Please see our spectate help page: http://br.op.gg/help/observer
echo ===================
@pause
goto exit
:exit